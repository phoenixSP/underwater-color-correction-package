...
if __name__ == '__main__':
   ...
   if len(sys.argv) < 3:
      print 'You must provide an info.pkl file and a filename'
      exit()
   ...
   EXPERIMENT_DIR  = 'checkpoints/NETWORK_'+NETWORK\
   ...
   if NETWORK == 'pix2pix_new': from pix2pix_new import *
   if NETWORK == 'pix2pix_new2': from pix2pix_new2 import *
   ...
   test_paths = []
   for ex in exts:
      test_paths.extend(glob.glob(sys.argv[2]+'/'+ex))
