...
def netG_decoder(layers, reuse=False):
   ...
   with tf.variable_scope(sc, reuse=reuse):
      ...
      dec_conv6 = tcl.convolution2d_transpose(enc_conv2, 64, 4, 2, activation_fn=tf.identity, weights_initializer=tf.random_normal_initializer(stddev=0.02), scope='g_dec_conv6')
